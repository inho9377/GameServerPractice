...
namespace NCommon
{
	...
	enum class ERROR_CODE : short
	{
		...
		LOBBY_CHAT_INVALID_DOMAIN = 265,
		LOBBY_CHAT_INVALID_LOBBY_INDEX = 266,
		LOBBY_CHAT_INVALID_ROOM_INDEX = 267,

		LOBBY_SECRET_CHAT_INVALID_DOMAIN = 268,
		LOBBY_SECRET_CHAT_INVALID_LOBBY_INDEX = 269,
		LOBBY_SECRET_CHAT_INVALID_ROOM_INDEX = 270,

		LOBBY_SECRET_CHAT_INVALID_SEND_USER = 300,
		LOBBY_USER_DIFFERENT_DOMAIN = 301,
